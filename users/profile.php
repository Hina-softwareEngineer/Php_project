...
<head>
    ...
    $row = mysqli_fetch_array($run_user);<!DOCTYPE html>
<?php
session_start();
include('../includes/header.php');
            ...
            echo "
                    <div>
                        ...
                        <form action='profile.php?u_id=$user_id' method='post' enctype='multipart/form-data' >
                            <ul class='nav pull-left' style='position : absolute; top:10px; left:100px;'>
                                <li class='dropdown'>
                                    <label>
    ...
    <div class="row">
        ...
        <div class="col-sm-2" style="background-color: #e6e6e6; text-align: center; left:0.8%; border-radius: 5px;">
            ...
            echo "
                ...
                <p><strong><i style='color:grey;'>$describe_user</i></strong></p>
